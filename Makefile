...
CXX_DEBUG_FLAGS := $(if $(DEBUG), -g -fsanitize=address -Wall -Wno-sign-compare,)
CXX_LD_DEBUG_FLAGS := $(if $(DEBUG), -fsanitize=address,)
export CXX_DEBUG_FLAGS
export CXX_LD_DEBUG_FLAGS
